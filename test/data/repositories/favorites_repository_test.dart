...
@GenerateMocks(<Type>[], customMocks: <MockSpec<dynamic>>[
  MockSpec<CollectionReference<Map<String, dynamic>>>(
      as: #MockCollectionReference, fallbackGenerators: {}),
  ...
  MockSpec<DocumentReference<String>>(as: #MockDocumentReferenceString),
  ...
  MockSpec<DocumentSnapshot<String>>(as: #MockDocumentSnapshotString),
])
void main() {
